...
import { OurWorkAPI } from '../API/API.js';
...
const Portfolio = () => {
    return (
        <>
            <Section>
                <Container>
                    <Slide direction="down"><Titlte><h2>Recent Projects</h2><h1>Our Work</h1></Titlte></Slide>
                    <GridImg>
                        {
                            OurWorkAPI && OurWorkAPI.map((val,ind)=>(
                                <div key={ind}><Slide direction="up"><Image><img src={val.wrkImgSrc} alt="ourwork/img" />
                                </Image></Slide></div>
                            ))
                        }
                    </GridImg>
                    <Zoom direction="down"><ButtonTheme>
                        <NavLink to="/projects" className="LearnMoreButton">Load More Work</NavLink>
                    </ButtonTheme></Zoom>
                </Container>
            </Section>
        </>
